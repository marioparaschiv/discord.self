...
"Voice" refers to Discord bots being able to send audio in voice channels. This is supported in discord.js via [@discord.self/voice](https://github.com/marioparaschiv/discord.self/tree/main/packages/voice), a standalone library made by the developers of discord.js. While you can use it with any Node.js Discord API library, this guide will focus on using it with discord.js.

## Installation

### Barebones

To add voice functionality to your discord.js bot, you will need the `@discord.self/voice` package. If your system does not support aes-256-gcm you also need one of the encryption packages listed below. For example:
