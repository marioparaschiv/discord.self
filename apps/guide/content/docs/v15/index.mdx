...
<Callout type="idea">
	**Version 15 is in a pre-release** state, but should be usable!   
    ...
    <GitHubIcon className="inline text-red-400"/> https://github.com/marioparaschiv/discord.self/issues
...
- [marioparaschiv/discord.self#10420](https://github.com/marioparaschiv/discord.self/pull/10420)
- [marioparaschiv/discord.self#10556](https://github.com/marioparaschiv/discord.self/pull/10556)
...
Removed `Guild#shard` as WebSocket shards are now handled by @discord.self/ws.
...
`WebSocketShardEvents` has been replaced with `WebSocketShardEvents` from @discord.self/ws.
