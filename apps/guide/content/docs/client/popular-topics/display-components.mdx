...
```js
const { TextDisplayBuilder, MessageFlags } = require('discord.self');
...
```js
const { SectionBuilder, ButtonStyle, MessageFlags } = require('discord.self');
...
```js
const { AttachmentBuilder, SectionBuilder, MessageFlags } = require('discord.self');
...
```js
const { AttachmentBuilder, MediaGalleryBuilder, MessageFlags } = require('discord.self');
...
```js
const { AttachmentBuilder, FileBuilder, MessageFlags } = require('discord.self');
...
```js
const { TextDisplayBuilder, SeparatorBuilder, SeparatorSpacingSize, MessageFlags } = require('discord.self');
...
```js
const { ContainerBuilder, UserSelectMenuBuilder, ButtonStyle, MessageFlags } = require('discord.self');
