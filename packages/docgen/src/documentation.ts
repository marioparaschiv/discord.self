...
export class Documentation {
	...
	public serializeNew() {
		return {
			metadata: {
				toolPackage: '@discord.self/docgen',
			...
			projectFolderUrl: 'https://github.com/marioparaschiv/discord.self/tree/main/packages/client',
			kind: 'Package',
			canonicalReference: '@discord.self/client!',
			docComment: '',
			name: '@discord.self/client',
