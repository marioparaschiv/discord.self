...
const typeScriptRuleset = merge(...typescript, {
	files: [`**/*${commonFiles}`],
	ignores: [`packages/client/**/*.{js,mjs,cjs}`],
	languageOptions: {
		parserOptions: {
...
export default defineConfig(
	...
	{
		files: [`packages/client/src/client/websocket/handlers/*.js`],
		rules: {
			'no-restricted-syntax': [
				'error',
				{
	...
	{
		files: [`packages/client/typings/*{d.ts,test-d.ts,d.mts,test-d.mts}`],
		rules: {
