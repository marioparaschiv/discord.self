...
```js
const { createAudioPlayer } = require('@discord.self/voice');
...
```js
const { createAudioPlayer, NoSubscriberBehavior } = require('@discord.self/voice');
...
```js
const { AudioPlayerStatus } = require('@discord.self/voice');
...
```js
const { createAudioResource } = require('@discord.self/voice');
