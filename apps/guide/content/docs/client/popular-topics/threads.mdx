...
```js
const { ChannelType, ThreadAutoArchiveDuration } = require('discord.self');
...
And that's it! Now you know all there is to know on working with threads using discord.self!
