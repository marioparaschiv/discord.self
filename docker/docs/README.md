...
- `guide` app on `http://localhost:3001/guide` (also linked from website `/guide/*`)
...
`GUIDE_REDIRECT_URL` and `GUIDE_BASE_PATH` are also baked into the website/guide bundles.
