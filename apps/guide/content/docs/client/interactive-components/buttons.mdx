...
```js
const { ButtonBuilder, ButtonStyle, SlashCommandBuilder } = require('discord.self');
...
```js
const { ActionRowBuilder, ButtonBuilder, ButtonStyle, SlashCommandBuilder } = require('discord.self');
...
const button = new ButtonBuilder()
	.setLabel('discord.self docs')
	.setURL('https://discord.self.org') // [!code word:setURL]
